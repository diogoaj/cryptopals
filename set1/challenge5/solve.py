...
def calculate_xor_key(string, key):
	length_string = len(string)
	length_key = len(key)

	quocient = length_string // length_key
	remainder = length_string % length_key

	xor_key = key*quocient
...
if __name__ == "__main__":
    ...
    deciphered = xor(string.encode(), calculate_xor_key(string, key).encode())
    print(encode(deciphered.encode(), "hex").decode())